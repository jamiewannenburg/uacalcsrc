...
public class GeneralAlgebraWrapper extends WrapperBase {
    ...
    private void handleCreate(Map<String, String> options) throws Exception {
        ...
        GeneralAlgebra algebra = new GeneralAlgebra(name);
    ...
    private void handleCreateWithUniverse(Map<String, String> options) throws Exception {
        ...
        GeneralAlgebra algebra = new GeneralAlgebra(name, universe);
    ...
    private void handleSetName(Map<String, String> options) throws Exception {
        String originalName = getRequiredArg(options, "original_name", "Original algebra name is required");
        String newName = getRequiredArg(options, "new_name", "New algebra name is required");
        
        GeneralAlgebra algebra = new GeneralAlgebra(originalName);
    ...
    private void handleDescription(Map<String, String> options) throws Exception {
        String name = getRequiredArg(options, "name", "Algebra name is required");
    ...
    private void handleCardinality(Map<String, String> options) throws Exception {
        ...
        if (!universeStr.isEmpty()) {
            ...
            algebra = new GeneralAlgebra(name, universe);
        } else {
            algebra = new GeneralAlgebra(name);
        }
    ...
    private void handleIsSimilarTo(Map<String, String> options) throws Exception {
        String name1 = getRequiredArg(options, "name1", "First algebra name is required");
        String name2 = getRequiredArg(options, "name2", "Second algebra name is required");
        
        GeneralAlgebra algebra1 = new GeneralAlgebra(name1);
        GeneralAlgebra algebra2 = new GeneralAlgebra(name2);
    ...
    private void handleTest(Map<String, String> options) throws Exception {
        ...
        GeneralAlgebra algebra = new GeneralAlgebra("TestAlgebra");
