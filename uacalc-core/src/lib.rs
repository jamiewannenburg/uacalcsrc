...
pub use fplat::{partially_defined_lattice_main, PartiallyDefinedLattice};
...
pub mod prelude {
    pub use crate::{
        ...
        identity_relation, maximals, ordered_sets_main, partially_defined_lattice_main,
        universal_relation, Algebra, BasicAlgebra, BasicBinaryRelation, BasicPartition,
        BinaryRelation, FlatOperationTable, FunctionOperation, Operation, OperationSymbol,
        OperationType, Order, PartiallyDefinedLattice, Partition, QuotientAlgebra, SmallAlgebra,
