...
impl TermArena {
    ...
    pub fn get_term(&self, id: TermId) -> UACalcResult<&Term> {
        self.terms.get(id).ok_or_else(|| UACalcError::InvalidOperation {
            message: format!("Invalid term ID: {}", id),
        })
    }
    ...
    pub fn get_term_mut(&mut self, id: TermId) -> UACalcResult<&mut Term> {
        self.terms.get_mut(id).ok_or_else(|| UACalcError::InvalidOperation {
            message: format!("Invalid term ID: {}", id),
        })
    }
    ...
    pub fn get_symbol(&self, id: u16) -> UACalcResult<&OperationSymbol> {
        self.symbols.get(id as usize).ok_or_else(|| UACalcError::InvalidOperation {
    ...
    pub fn memory_stats(&self) -> ArenaStats {
        ...
        ArenaStats {
            ...
            map_memory: self.symbol_map.len() * (std::mem::size_of::<String>() + std::mem::size_of::<u16>()),
