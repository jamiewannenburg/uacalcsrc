...
This repository contains a **Rust/Python implementation** of the Universal Algebra Calculator (UACalc), providing high-performance computational algebra capabilities with Python bindings.
...
# Setup Python environment and build bindings
python3 -m venv venv
...
# Use in Python
python -c "import uacalc_lib; print('UACalc loaded successfully!')"
```
...
# Install from wheel
pip install uacalc_lib/target/wheels/uacalc-*.whl
```

## Project Structure

```
├── src/                          # Main Rust application (mirrors Java org/uacalc/)
│   ├── alg/                      # Algebra structures & operations
...
- **High Performance**: Rust core for computational efficiency
...
This project provides both Rust and Python APIs:

### Rust API
```rust
use uacalc::alg::*;
// Direct access to high-performance algebra structures
```

### Python API
```python
import uacalc_lib
# Access all Rust functionality from Python
```
...
# Original UACalc Java Implementation
