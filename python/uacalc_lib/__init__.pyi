...
class group:
    ...
    class PermutationGroup:
        ...
        @staticmethod
        def automorphism_group(alg: "alg.BasicAlgebra") -> "group.PermutationGroup": ...
        ...
        def to_basic_algebra(self, name: str) -> "alg.BasicAlgebra": ...
...
class alg:
    ...
    class BasicAlgebra:
        ...
        @staticmethod
        def new_with_constant_op(name: str, universe: List[Any]) -> "alg.BasicAlgebra": ...
        @staticmethod
        ...
        def get_element(self, k: int) -> Any: ...
        def element_index(self, elem: Any) -> int: ...
        def get_universe_list(self) -> Optional[List[Any]]: ...
        def get_universe_order(self) -> Optional[Dict[Any, int]]: ...
    ...
    class Subalgebra:
        ...
        """
        def get_universe(self) -> List[Any]: ...
        """Get the universe using the super algebra's Python elements.
        
        Returns:
            The universe elements as a list
        """
        def get_universe_list(self) -> Optional[List[Any]]: ...
    ...
    class ReductAlgebra:
        ...
        """
        def element_index(self, element: Any) -> Optional[int]: ...
